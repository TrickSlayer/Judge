<%-- 
    ...
    Created on : Oct 28, 2021, 7:59:25 PM
    Author     : Acer
--%>
    ...
    <body>
        ...
        <div class="container">
            <div class="body">
                ...
                <form action="search-by-genre?page=1&&genre=1,2,3,9" method="post">
                    <table>
                        <%  int count = 0;
                        %>
                        <tr>
                                ...
                                <td>
                                    <div class="box">
                                        <input type="checkbox" name="Genre" value="${g.genreId}"
                                               <c:forEach items="${requestScope.genresId}" var="gID">
                                                   <c:if test="${g.genreId == gID}">
                                                       checked
                                                   </c:if>
                                               </c:forEach>                        
                                               /> ${g.genre}</div>     
                    ...
                    <button style="margin-left: 2%; color: black" type="submit">Search</button>
                </form>
                ...
                <div class="button">
                    ...
                    %>
                    <a href="search-by-genre?page=<%= i%><%= id%>"
                       <%
                           if (i == currentPage) {
                       %>
