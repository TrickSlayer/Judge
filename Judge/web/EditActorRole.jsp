<%-- 
    Document   : EditActorRole
    Created on : Oct 13, 2021, 5:03:13 PM
    Author     : Acer
--%>
...
<html>
    ...
    <body>
        ...
        <div class="container">
            <div class="body">
                <h2>Edit Actor Roll</h2>
                <h4 class="erro">${requestScope.error}</h4>
                <form action="edit-actor-role?id=<%= request.getParameter("id")%>" method="post">
                    <div>
                            ...
                            <c:forEach items="${requestScope.listActorRole}" var="ar">
                                ...
                                <tr>
                                    ...
                                    <td><input name="${a.getActorID()}" type="text" value="${ar.getRole()}"
                                               class="input" placeholder="" ></td>
                                    <td><input type="checkbox" name="ActorID" value="${a.getActorID()}" checked></td>
                                </tr>
                            </c:forEach>
                        </table>
                    </c:if>
                    <button type="submit" class="btn btn-primary addrole" name="action" value="Confirm">Confirm</button>
