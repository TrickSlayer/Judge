...
public class SearchMovieServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.setAttribute("list", m.getSearchMoviePage(name, page));
        request.setAttribute("search", "Search: " + name);
        request.setAttribute("page", m.sizeSearchMovie(name) / 10 + (m.sizeSearchMovie(name) % 10 > 0 ? 1 : 0));
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        String name = request.getParameter("name");
        response.sendRedirect("search-movie?page=1&name=" + name+"&order=desc");
    }
